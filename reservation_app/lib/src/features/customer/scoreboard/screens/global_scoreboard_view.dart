...
class GlobalScoreboardView extends StatefulWidget {
  const GlobalScoreboardView({super.key});

  @override
  State<GlobalScoreboardView> createState() => _GlobalScoreboardViewState();
}

class _GlobalScoreboardViewState extends State<GlobalScoreboardView> {
  @override
