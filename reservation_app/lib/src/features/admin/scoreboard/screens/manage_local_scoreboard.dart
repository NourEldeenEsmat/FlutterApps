...
class LocalScoreboard extends StatefulWidget {
  const LocalScoreboard({super.key});

  @override
  State<LocalScoreboard> createState() => _LocalScoreboardState();
}

class _LocalScoreboardState extends State<LocalScoreboard> {
  @override
